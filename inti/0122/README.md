...
Once this is created - for this writeup the app is stored in [challenge-app/debug-0122](challenge-app/debug-0122) - we copy the left over source files generated from the sourcemap to that newly created React app's `src` file:
...
This writeup contains a test project to show the use of sourcemaps: [./sourcemaps-test](https://github.com/svennergr/writeups/inti/0122/sourcemaps-test)
It also contains the raw files which are generated by [originmap](https://github.com/svennergr/originmap): [./challenge-app/raw](https://github.com/svennergr/writeups/inti/0122/challenge-app/raw)
It also contains a React app, which recreates the challenge locally and was used to deobfuscate it: [./challenge-app/debug-0122](https://github.com/svennergr/writeups/inti/0122/challenge-app/debug-0122)
